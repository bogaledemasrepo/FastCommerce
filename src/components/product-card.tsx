  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-2 border border-blue-300 hover:bg-blue-500 transition duration-200 hover:text-white rounded-md absolute left-2 right-2 bottom-2 flex  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
      >
